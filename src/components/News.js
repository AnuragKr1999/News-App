...
export default class News extends Component {
  ...
  async componentDidMount() {
    ...
    let url = `https://newsapi.org/v2/top-headlines?country=in&apiKey=0e746d560d594ca19a6571531efc98ca&page=1&pageSize=${this.props.pageSize}`;
  ...
  handleNextClick = async () => {
    ...
    let url = `https://newsapi.org/v2/top-headlines?country=in&apiKey=0e746d560d594ca19a6571531efc98ca&page=${
      this.state.page + 1
